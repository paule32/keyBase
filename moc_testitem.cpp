/****************************************************************************
** Meta object code from reading C++ file 'testitem.h'
**
...
#error "The header file 'testitem.h' doesn't include <QObject>."
...
const QMetaObject testitem::staticMetaObject = {
    { &QAbstractListModel::staticMetaObject, qt_meta_stringdata_testitem.data,
      qt_meta_data_testitem,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *testitem::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_testitem.stringdata0))
        return static_cast<void*>(const_cast< testitem*>(this));
