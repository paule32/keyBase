#ifndef MYDESIGNERCORNERGRABBER_H
#define MYDESIGNERCORNERGRABBER_H
...
class MyDesignerCornerGrabber: public QGraphicsItem
{
public:
    explicit MyDesignerCornerGrabber(QGraphicsItem *parent = 0,  int corner=0);
...
#endif // MYDESIGNERCORNERGRABBER_H
